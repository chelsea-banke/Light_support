...
import { MapComponent } from '@/components/map-view/asset-map';
...
export default function AssetMapScreen() {
  ...
  const [userLocation, setUserLocation] = useState<[number, number]>([4.2174, 9.1727]);
  const [focusLocation, setFocusLocation] = useState<[number, number]>([9.1727, 4.2174]);
        ...
        <View style={styles.sheetContent}>
          ...
          <View style={styles.distanceContainer}>
            <TouchableOpacity onPress={() => setFocusLocation(userLocation)}>
              <Entypo name="location" size={24} color="#c2e600" />
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => setFocusLocation([9.1727, 4.2174])}>
              <Foundation name="target-two" size={28} color="#c2e600" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.galleryRow}>
            <View style={styles.galleryItemLarge}>
              ...
              <Text style={styles.galleryLabel}>1st</Text>
            </View>
            <View style={styles.galleryItemSmall}>
              <FontAwesome name="image" size={20} color="#aaa" />
              <Text style={styles.galleryLabel}>2nd</Text>
            </View>
          </View>
